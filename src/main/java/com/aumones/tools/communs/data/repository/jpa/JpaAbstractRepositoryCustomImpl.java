...
@Repository
public class JpaAbstractRepositoryCustomImpl<T extends JpaAbstractModel, S extends AbstractSearchRequestDto>
    implements JpaAbstractRepositoryCustom<T, S> {
  ...
  public List<Predicate> setListPredicates(S searchRequest, CriteriaBuilder criteriaBuilder, Root<T> root) {
